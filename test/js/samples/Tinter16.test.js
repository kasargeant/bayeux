...
unit("Class: Tinter (Node/16-color [using CSS Named colors])", function() {
    ...
    test("Colorization functions (foreground)", function(done) {
        ...
        equal(Tinter.black(DUMMY_STRING), `\x1b[1m\x1b[30m${DUMMY_STRING}\x1b[0m`, "it should be able mark a string as black.");
        equal(Tinter.red(DUMMY_STRING), `\x1b[1m\x1b[91m${DUMMY_STRING}\x1b[0m`, "it should be able mark a string as red.");
        equal(Tinter.green(DUMMY_STRING), `\x1b[1m\x1b[32m${DUMMY_STRING}\x1b[0m`, "it should be able mark a string as green.");
        equal(Tinter.yellow(DUMMY_STRING), `\x1b[1m\x1b[93m${DUMMY_STRING}\x1b[0m`, "it should be able mark a string as yellow.");
        equal(Tinter.blue(DUMMY_STRING), `\x1b[1m\x1b[94m${DUMMY_STRING}\x1b[0m`, "it should be able mark a string as blue.");
        equal(Tinter.magenta(DUMMY_STRING), `\x1b[1m\x1b[95m${DUMMY_STRING}\x1b[0m`, "it should be able mark a string as magenta.");
        equal(Tinter.cyan(DUMMY_STRING), `\x1b[1m\x1b[96m${DUMMY_STRING}\x1b[0m`, "it should be able mark a string as cyan.");
        equal(Tinter.white(DUMMY_STRING), `\x1b[1m\x1b[97m${DUMMY_STRING}\x1b[0m`, "it should be able mark a string as white.");
    ...
    test("Colorization functions (background)", function(done) {
        ...
        equal(Tinter.blackBg(DUMMY_STRING), `\x1b[1m\x1b[40m${DUMMY_STRING}\x1b[0m`, "it should be able mark a string with a black background.");
        equal(Tinter.redBg(DUMMY_STRING), `\x1b[1m\x1b[101m${DUMMY_STRING}\x1b[0m`, "it should be able mark a string with a red background.");
        equal(Tinter.greenBg(DUMMY_STRING), `\x1b[1m\x1b[42m${DUMMY_STRING}\x1b[0m`, "it should be able mark a string with a green background.");
        equal(Tinter.yellowBg(DUMMY_STRING), `\x1b[1m\x1b[103m${DUMMY_STRING}\x1b[0m`, "it should be able mark a string with a yellow background.");
        equal(Tinter.blueBg(DUMMY_STRING), `\x1b[1m\x1b[104m${DUMMY_STRING}\x1b[0m`, "it should be able mark a string with a blue background.");
        equal(Tinter.magentaBg(DUMMY_STRING), `\x1b[1m\x1b[105m${DUMMY_STRING}\x1b[0m`, "it should be able mark a string with a magenta background.");
        equal(Tinter.cyanBg(DUMMY_STRING), `\x1b[1m\x1b[106m${DUMMY_STRING}\x1b[0m`, "it should be able mark a string with a cyan background.");
        equal(Tinter.whiteBg(DUMMY_STRING), `\x1b[1m\x1b[107m${DUMMY_STRING}\x1b[0m`, "it should be able mark a string with a white background.");
    ...
    test("Colorization functions (composite)", function(done) {
        ...
        equal(Tinter.style(DUMMY_STRING, "yellow", "blue", "italic"), `\x1b[3m\x1b[1m\x1b[104m\x1b[1m\x1b[93m${DUMMY_STRING}\x1b[0m`, "it should be able mark a string with overlapping characteristics.");
        // equal(Tinter.rgb(DUMMY_STRING, [255,255,127], [192, 0, 55], "underline"), `\x1b[4m\x1b[1m\x1b[101m\x1b[1m\x1b[93m${DUMMY_STRING}\x1b[0m`, "it should degrade a truecolor to 16-color appropriately.");
        equal(Tinter.Black(DUMMY_STRING), `\x1b[1m\x1b[30m${DUMMY_STRING}\x1b[0m`, "it should correctly support ANSI named colors.");
        equal(Tinter.rebeccapurple(DUMMY_STRING), `\x1b[1m\x1b[34m${DUMMY_STRING}\x1b[0m`, "it should correctly support CSS4 named colors.");
