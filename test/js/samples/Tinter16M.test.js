...
unit("Class: Tinter (Node/16M+ truecolor [using CSS Named colors])", function() {
    ...
    test("Colorization functions (foreground)", function(done) {
        ...
        equal(Tinter.black(DUMMY_STRING), `\x1b[1m\x1b[38;2;0;0;0m${DUMMY_STRING}\x1b[0m`, "it should be able mark a string as black.");
        equal(Tinter.red(DUMMY_STRING), `\x1b[1m\x1b[38;2;255;0;0m${DUMMY_STRING}\x1b[0m`, "it should be able mark a string as red.");
        equal(Tinter.green(DUMMY_STRING), `\x1b[1m\x1b[38;2;0;128;0m${DUMMY_STRING}\x1b[0m`, "it should be able mark a string as green.");
        equal(Tinter.yellow(DUMMY_STRING), `\x1b[1m\x1b[38;2;255;255;0m${DUMMY_STRING}\x1b[0m`, "it should be able mark a string as yellow.");
        equal(Tinter.blue(DUMMY_STRING), `\x1b[1m\x1b[38;2;0;0;255m${DUMMY_STRING}\x1b[0m`, "it should be able mark a string as blue.");
        equal(Tinter.magenta(DUMMY_STRING), `\x1b[1m\x1b[38;2;255;0;255m${DUMMY_STRING}\x1b[0m`, "it should be able mark a string as magenta.");
        equal(Tinter.cyan(DUMMY_STRING), `\x1b[1m\x1b[38;2;0;255;255m${DUMMY_STRING}\x1b[0m`, "it should be able mark a string as cyan.");
        equal(Tinter.white(DUMMY_STRING), `\x1b[1m\x1b[38;2;255;255;255m${DUMMY_STRING}\x1b[0m`, "it should be able mark a string as white.");
    ...
    test("Colorization functions (background)", function(done) {
        ...
        equal(Tinter.blackBg(DUMMY_STRING), `\x1b[1m\x1b[48;2;0;0;0m${DUMMY_STRING}\x1b[0m`, "it should be able mark a string with a black background.");
        equal(Tinter.redBg(DUMMY_STRING), `\x1b[1m\x1b[48;2;255;0;0m${DUMMY_STRING}\x1b[0m`, "it should be able mark a string with a red background.");
        equal(Tinter.greenBg(DUMMY_STRING), `\x1b[1m\x1b[48;2;0;128;0m${DUMMY_STRING}\x1b[0m`, "it should be able mark a string with a green background.");
        equal(Tinter.yellowBg(DUMMY_STRING), `\x1b[1m\x1b[48;2;255;255;0m${DUMMY_STRING}\x1b[0m`, "it should be able mark a string with a yellow background.");
        equal(Tinter.blueBg(DUMMY_STRING), `\x1b[1m\x1b[48;2;0;0;255m${DUMMY_STRING}\x1b[0m`, "it should be able mark a string with a blue background.");
        equal(Tinter.magentaBg(DUMMY_STRING), `\x1b[1m\x1b[48;2;255;0;255m${DUMMY_STRING}\x1b[0m`, "it should be able mark a string with a magenta background.");
        equal(Tinter.cyanBg(DUMMY_STRING), `\x1b[1m\x1b[48;2;0;255;255m${DUMMY_STRING}\x1b[0m`, "it should be able mark a string with a cyan background.");
        equal(Tinter.whiteBg(DUMMY_STRING), `\x1b[1m\x1b[48;2;255;255;255m${DUMMY_STRING}\x1b[0m`, "it should be able mark a string with a white background.");
    ...
    test("Colorization functions (composite)", function(done) {
        ...
        equal(Tinter.style(DUMMY_STRING, "yellow", "blue", "italic"), `\x1b[3m\x1b[1m\x1b[48;2;0;0;255m\x1b[1m\x1b[38;2;255;255;0m${DUMMY_STRING}\x1b[0m`, "it should be able mark a string with overlapping characteristics.");
        ...
        equal(Tinter.Black(DUMMY_STRING), `\x1b[1m\x1b[38;2;0;0;0m${DUMMY_STRING}\x1b[0m`, "it should correctly support ANSI named colors.");
        equal(Tinter.rebeccapurple(DUMMY_STRING), `\x1b[1m\x1b[38;2;102;51;153m${DUMMY_STRING}\x1b[0m`, "it should correctly support CSS4 named colors.");
    ...
    test("Truecolor functions", function(done) {
        ...
        // public method
        equal(Tinter.rgb(DUMMY_STRING, [255,255,127], [192, 0, 55], "underline"), `\x1b[4m\x1b[1m\x1b[48;2;192;0;55m\x1b[1m\x1b[38;2;255;255;127m${DUMMY_STRING}\x1b[0m`, "it should NOT degrade truecolor RGB values in a 16M+ color environment");
        equal(Tinter.rgb(DUMMY_STRING, [255,255,127], [192, 0, 55]), `\x1b[0m\x1b[1m\x1b[48;2;192;0;55m\x1b[1m\x1b[38;2;255;255;127m${DUMMY_STRING}\x1b[0m`, "it should NOT degrade truecolor RGB values in a 16M+ color environment when using defaults (3 params)");
        equal(Tinter.rgb(DUMMY_STRING, [255,255,127]), `\x1b[0m\x1b[1m\x1b[48;2;0;0;0m\x1b[1m\x1b[38;2;255;255;127m${DUMMY_STRING}\x1b[0m`, "it should NOT degrade truecolor RGB values in a 16M+ color environment when using defaults (2 params)");
        equal(Tinter.rgb(DUMMY_STRING), `\x1b[0m\x1b[1m\x1b[48;2;0;0;0m\x1b[1m\x1b[38;2;255;255;255m${DUMMY_STRING}\x1b[0m`, "it should NOT degrade truecolor RGB values in a 16M+ color environment when using defaults (1 params)");
